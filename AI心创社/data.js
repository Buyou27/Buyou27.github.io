    ...
    departments: [
      {
        ...
        description:
          "我们是技术部，也是刚起步的TechLakeCommunity。我们有服务器，有域名，还有一个已经跑起来的问答社区。小白也能来，我们带你从头做。不会的我们一起踩坑，写完的我们帮你上线。社区会开放接口，欢迎你在里面创造；服务器也随时就位，跑起你自己的项目。让我们一起把TechLakeCommunity变得更好。",
        responsibilities: [
          "AI 技术探索",
          "产品原型开发",
          "项目研发协作",
