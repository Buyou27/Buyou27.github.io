(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  {
    otherChunks: [
      "static/chunks/0-t57aycj0uqz.js",
      "static/chunks/0.9kuvj2efgbu.js",
      "static/chunks/10mplx1qo1yfm.js",
    ],
    runtimeModuleIds: [84329],
  },
]),
  (() => {
    let e;
    ...
    s.a = function (e, t) {
      let r = this.m,
        ...
        o = new Set(),
        { resolve: l, reject: i, promise: u } = j(),
        s = Object.assign(u, {
          [U]: r.exports,
          [k]: (e) => {
        ...
        e(
          function (e) {
            let t = e.map((e) => {
              ...
              u = Object.assign(() => i(r), { queueCount: 0 });
            function s(e) {
              e !== n &&
                !o.has(e) &&
                (o.add(e), e && 0 === e.status && (u.queueCount++, e.push(u)));
            }
            return t.map((e) => e[k](s)), u.queueCount ? l : r();
          },
          function (e) {
            e ? i((s[v] = e)) : l(s[U]), C(n);
          },
    ...
    async function T(e, t, r) {
      ...
      let i = r.moduleChunks || [],
        u = i.map((e) => _.get(e)).filter((e) => e);
      if (u.length > 0) {
        if (u.length === i.length) return void (await Promise.all(u));
        let r = new Set();
        ...
        for (let o of ((n = M(e, t, q(r.path))), i)) _.has(o) || _.set(o, n);
      }
    ...
    (S.L = function (e) {
      ...
      (S.b = function (e, t, o, l) {
        let i = "SharedWorker" === e.name,
          u = [o.map((e) => q(e)).reverse(), r];
        for (let e of n) u.push(globalThis[e]);
        let s = new URL(q(t), location.origin),
          a = JSON.stringify(u);
        return (
          i
            ? s.searchParams.set("params", a)
            : (s.hash = "#params=" + encodeURIComponent(a)),
          new e(s, l ? { ...l, type: void 0 } : void 0)
        );
      });
    let N = /\.js(?:\?[^#]*)?(?:#.*)?$/,
      K = /\.css(?:\?[^#]*)?(?:#.*)?$/;
